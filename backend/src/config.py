"""Configuration for the LangGraph-based legal research agent."""
...
class Configuration(BaseModel):
    """Configuration options for the legal research assistant."""
    ...
    strip_thinking_tokens: bool = Field(
        ...
        description="Whether to strip <think> tags from model responses",
    )
    llm_api_key: Optional[str] = Field(
        default=None,
        title="LLM API Key",
        description="Optional API key for custom OpenAI-compatible services",
    )
    llm_base_url: Optional[str] = Field(
        default=None,
        title="LLM Base URL",
        description="Optional base URL for custom OpenAI-compatible services",
    )
